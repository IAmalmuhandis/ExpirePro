...
const Welcome = () => {
  ...
  const onboardingScreens = [
    { title: 'Welcome to ExpirePro', image: 'anime1' },
    { title: 'Minimize Food Waste', image:'anime2' },
    { title: 'Effortless Expiry Management', image: 'anime3' },
  ];
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    position: 'absolute',
    top: 700, // Adjust the distance from the top as needed
